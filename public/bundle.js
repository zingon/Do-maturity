	...
	var Main = function (_React$Component) {
		...
		_createClass(Main, [{
			...
			value: function changeTime() {
				var now = new Date();
				var date = Date.parse(this.state.endtime);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Time2.default, { time: this.state.time })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Time.propTypes = { time: _react2.default.PropTypes.object };
